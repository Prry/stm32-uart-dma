...
#define PLL_SOURCE_HSE        // HSE (12MHz) used to clock the PLL, and the PLL is used as system clock source
...
/** @addtogroup STM32F0xx_System_Private_Variables
  * @{
  */
#define USE_48MHZ_MAIN_COLOCK

#ifdef PLL_SOURCE_HSI 
	#ifdef USE_48MHZ_MAIN_COLOCK
...
static void SetSysClock(void)
{
	  ...
	  if (HSEStatus == (uint32_t)0x01)
	  {
		...
		/* PLL configuration = HSE * 4 = 48 MHz */
		RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
